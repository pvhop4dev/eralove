...
// LogRequestParsed logs successful request parsing
func LogRequestParsed(logger *zap.Logger, operation string, fields ...zap.Field) {
	allFields := append([]zap.Field{zap.String("operation", operation)}, fields...)
	logger.Info("Request parsed successfully", allFields...)
}

// LogValidationError logs validation errors
func LogValidationError(logger *zap.Logger, err error, operation string, fields ...zap.Field) {
...
// LogServiceCall logs when calling service layer
func LogServiceCall(logger *zap.Logger, operation string, fields ...zap.Field) {
	allFields := append([]zap.Field{zap.String("operation", operation)}, fields...)
	logger.Info("Calling service layer", allFields...)
}

// LogServiceError logs service layer errors
func LogServiceError(logger *zap.Logger, err error, operation string, fields ...zap.Field) {
	allFields := append([]zap.Field{
		zap.Error(err),
...
func LogServiceSuccess(logger *zap.Logger, operation string, fields ...zap.Field) {
	allFields := append([]zap.Field{zap.String("operation", operation)}, fields...)
